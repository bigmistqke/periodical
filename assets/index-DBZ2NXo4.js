...
const calendarContainer = "_calendarContainer_btgtr_1";
const calendar = "_calendar_btgtr_1";
const cell = "_cell_btgtr_86";
const indicator = "_indicator_btgtr_96";
const today = "_today_btgtr_127";
const past = "_past_btgtr_132";
const styles$4 = {
